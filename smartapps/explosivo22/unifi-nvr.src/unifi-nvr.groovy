...
preferences {
    input name: "nvrAddress", type: "text", title: "NVR Address", description: "NVR IP address", required: true, displayDuringSetup: true, defaultValue: "192.168.167.73"
    input name: "nvrPublicAddress", type: "text", title: "NVR Public Address", description: "NVR Public IP address", required: true, displayDuringSetup: true, defaultValue: "73.80.58.139"
    ...
    input name: "username", type: "text", title: "Username", description: "Username", required: true, displayDuringSetup: true, defaultValue: "admin"
    input name: "password", type: "text", title: "Password", description: "Password", required: true, displayDuringSetup: true, defaultValue: "mcePass4tv"
}
